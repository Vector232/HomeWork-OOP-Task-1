...
class Person:
    ...
    # За корректную работу можно не волноваться т к в данном задании при вызове этого метода у любого объекта чей клас не обладает
    # параметром grade в любом случае возникнет исключение. Т е нет разницы(в этом задании) пишем мы метод только для нужных классов (студенты и лекторы) или наследуем всеми (студенты лекторы И эксперты)
